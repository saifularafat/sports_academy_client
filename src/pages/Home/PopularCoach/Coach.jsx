    ...
    return (
        <div className=" hover:shadow-xl rounded-lg transition duration-200">
            <div
                ...
                <img src={person.coach_img} alt="Coach-image" className="w-full md:h-80 h-64 rounded-lg grayscale transition duration-500" />
                <div className="absolute top-0 left-0 w-full md:h-80 h-64 opacity-0 hover:opacity-100 transition duration-500 ">
                    <img src={person.coach_img} alt="Coach-image" className="w-full md:h-80 h-64 rounded-lg grayscale-0" />
                </div>
