...
import loginLottie from '../../assets/login/login.json'
...
const Login = () => {
    ...
    return (
        <div className=' bg-signUpImage'>
            <Container>
                <div className="md:flex justify-center items-center">
                    <Helmet>
                        <title>SK Academy || Login</title>
                    </Helmet>
                    <Lottie
                        animationData={loginLottie}
                        loop={true} className="md:w-3/6" />
                    {/* TODO lottieFile */}
                    <div className='flex flex-col md:w-4/12  bg-green-100 p-8  rounded-md sm:p-10 text-gray-900'>
