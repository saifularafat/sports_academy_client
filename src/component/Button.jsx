...
const Button = ({ adders, label }) => {
    return (
        <Link to={adders}
            className="border-2 hidden md:block border-accent hover:border-color-btn/70 text-xl font-mono font-medium rounded-xl py-2 px-5 relative md:inline-flex items-center justify-start overflow-hidden transition-all group">
